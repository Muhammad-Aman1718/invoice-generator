...
//     <div
//       className={cn(
//         "flex flex-col gap-6 w-full max-w-sm mx-auto",
//         className
//       )}
//       {...props}
//     >
...
export function SignUpForm({
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="absolute inset-0 flex items-center">
          <span className="w-full border-t" style={{ borderColor: "#1B2A4A15" }} />
        </div>
      ...
      <form onSubmit={handleSignUp} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          {repeatPassword.length > 0 && (
            <p
              ...
              style={{
                color:
                  password === repeatPassword ? "#16a34a" : "#DC2626",
              }}
            >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!isLoading)
              (e.currentTarget as HTMLButtonElement).style.background = "#2C62B0";
          }}
          onMouseLeave={(e) => {
