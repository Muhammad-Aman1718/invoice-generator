...
// // ─────────────────────────────────────────────
// //  COLOR THEME & STYLES (High Contrast for Accessibility)
// // ─────────────────────────────────────────────

// const INPUT_CLASS =
//   "w-full h-11 px-4 rounded-xl border text-sm outline-none transition-all bg-white " +
//   "border-[#191970]/20 text-[#191970] font-medium placeholder:text-[#191970]/40 " +
//   "focus:border-[#FFC107] focus:ring-2 focus:ring-[#FFC107]/20";

// const LABEL_CLASS = "block text-[11px] font-black uppercase tracking-widest text-[#191970]/70";
...
//         background: "#ffffff",
//         borderColor: "rgba(25,25,112,0.1)",
//         boxShadow: "0 10px 40px rgba(25,25,112,0.08)",
//       }}
//       {...props}
//       role="region"
...
//     >
//       {/* Amber top bar */}
//       <div className="h-1.5 w-full" style={{ background: "#FFC107" }} />
...
//             style={{ background: "#191970" }}
//           >
//             <FileText size={22} style={{ color: "#FFC107" }} aria-hidden="true" />
//           </div>
//           <h1
//             className="text-2xl font-black tracking-tight"
//             style={{ color: "#191970" }}
...
//             Welcome back
//           </h1>
//           <p className="text-sm font-medium" style={{ color: "rgba(25,25,112,0.6)" }}>
...
//             className="w-full h-11 flex items-center justify-center gap-3 rounded-xl border text-sm font-bold transition-all hover:bg-[#ECEFF1]"
//             style={{ 
//               background: "#F8FAFC", 
//               borderColor: "rgba(25,25,112,0.1)", 
//               color: "#191970" 
...
//           <span className="text-[10px] font-black uppercase tracking-widest text-[#191970]/40">OR EMAIL</span>
//           <div className="flex-1 border-t border-[#191970]/10" />
//         </div>
...
//               <Link
//                 href="/auth/forgot-password"
//                 className="text-[11px] font-black text-[#191970] hover:text-[#FFC107] transition-colors"
//               >
//                 Forgot?
//               </Link>
//             </div>
...
//                 className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-[#191970]/30 hover:text-[#FFC107] transition-colors"
//               >
...
//             <div
//               role="alert"
//               className="text-xs font-bold p-3 rounded-xl bg-red-50 border border-red-200 text-red-600 flex items-center gap-2"
//             >
//               <span className="flex-shrink-0 w-4 h-4 rounded-full bg-red-600 text-white flex items-center justify-center text-[10px]">!</span>
//               {error}
//             </div>
//           )}
...
//             type="submit"
//             disabled={isLoading}
//             className="w-full h-12 rounded-xl text-sm font-black transition-all disabled:opacity-70 disabled:cursor-not-allowed"
//             style={{
//               background: "#191970",
//               color: "#ffffff",
...
//         {/* ── Footer Landmark ── */}
//         <footer
//           className="text-center text-xs border-t pt-5"
//           style={{ borderColor: "rgba(25,25,112,0.05)" }}
//         >
//           <span style={{ color: "rgba(25,25,112,0.6)" }}>New to our platform? </span>
//           <Link
//             href={`/auth/sign-up${queryString ? `?${queryString}` : ""}`}
//             className="font-black hover:underline"
//             style={{ color: "#191970" }}
...
// High Contrast Colors for 100% Accessibility
const DARK_BLUE = "#191970";
const AMBER = "#FFC107";
const MUTED_TEXT = "#475569"; // Clearer than opacity-based colors
...
export function LoginForm({
  ...
  return (
    <section
      className={cn("w-full max-w-md mx-auto rounded-2xl border overflow-hidden bg-white shadow-xl", className)}
    ...
    >
      ...
      <div className="p-7 sm:p-8 flex flex-col gap-6">
        ...
        {/* OAuth Section */}
        <nav className="grid gap-3" aria-label="Social Login">
          <button
            type="button"
            onClick={() => handleOAuth("google")}
            className="w-full h-11 flex items-center justify-center gap-3 rounded-xl border border-slate-200 text-sm font-bold transition-all hover:bg-slate-50 text-[#191970]"
          >
        ...
        <div className="relative flex items-center gap-3">
          <div className="flex-1 border-t  border-[#191970]/10" />
          <span className="text-[10px] font-black uppercase tracking-widest text-[#191970]/80">OR EMAIL</span>
          <div className="flex-1 border-t   border-[#191970]/10 " />
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {error && (
            <div
              role="alert"
              className="text-sm font-bold p-3 rounded-xl bg-red-50 border border-red-200 text-red-700 flex items-center gap-2"
            >
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-red-700 text-white flex items-center justify-center text-[10px]">!</span>
              {error}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full h-12 rounded-xl text-sm font-black transition-all bg-[#191970] text-white hover:bg-[#FFC107] hover:text-[#191970] disabled:opacity-50 shadow-lg shadow-blue-900/10"
          >
